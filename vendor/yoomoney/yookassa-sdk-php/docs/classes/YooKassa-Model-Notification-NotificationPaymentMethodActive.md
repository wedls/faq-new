...
# Class: \YooKassa\Model\Notification\NotificationPaymentMethodActive
### Namespace: [\YooKassa\Model\Notification](../namespaces/yookassa-model-notification.md)
---
**Summary:**

Класс объекта, присылаемого API при сохранении способа оплаты.
...
| public | [$object](../classes/YooKassa-Model-Notification-NotificationPaymentMethodActive.md#property_object) |  | Объект с информацией о способе оплаты |
...
| public | [fromArray()](../classes/YooKassa-Model-Notification-NotificationPaymentMethodActive.md#method_fromArray) |  | Конструктор объекта нотификации о способе оплаты. |
| public | [getEvent()](../classes/YooKassa-Model-Notification-AbstractNotification.md#method_getEvent) |  | Возвращает тип события. |
| public | [getObject()](../classes/YooKassa-Model-Notification-NotificationPaymentMethodActive.md#method_getObject) |  | Возвращает объект с информацией о способе оплаты, уведомление о котором хранится в текущем объекте. |
...
| public | [setObject()](../classes/YooKassa-Model-Notification-NotificationPaymentMethodActive.md#method_setObject) |  | Устанавливает объект с информацией о способе оплаты, уведомление о котором хранится в текущем объекте. |
...
---
### Details
* File: [lib/Model/Notification/NotificationPaymentMethodActive.php](../../lib/Model/Notification/NotificationPaymentMethodActive.php)
...
* Class Hierarchy:  
  ...
  * \YooKassa\Model\Notification\NotificationPaymentMethodActive
...
Объект с информацией о способе оплаты
...
Конструктор объекта нотификации о способе оплаты.
...
**Details:**
* Inherited From: [\YooKassa\Model\Notification\NotificationPaymentMethodActive](../classes/YooKassa-Model-Notification-NotificationPaymentMethodActive.md)
...
| Type | Description |
| ---- | ----------- |
| \YooKassa\Common\Exceptions\InvalidPropertyValueException | Генерируется если значение типа нотификации или события не равны "notification" и "payment_method.active" соответственно, что может говорить о том, что переданные в конструктор данные не являются уведомлением нужного типа. |
...
#### public getObject() : \YooKassa\Model\SavePaymentMethod\SavePaymentMethodInterface
...
Возвращает объект с информацией о способе оплаты, уведомление о котором хранится в текущем объекте.

**Description**

Так как нотификация может быть сгенерирована и поставлена в очередь на отправку гораздо раньше, чем она будет
получена на сайте, то опираться на статус пришедшего способа оплаты не стоит, лучше запросить текущую информацию о
способе оплаты у API.

**Details:**
* Inherited From: [\YooKassa\Model\Notification\NotificationPaymentMethodActive](../classes/YooKassa-Model-Notification-NotificationPaymentMethodActive.md)

**Returns:** \YooKassa\Model\SavePaymentMethod\SavePaymentMethodInterface - Объект с информацией о способе оплаты
...
```php
public setObject(\YooKassa\Model\SavePaymentMethod\SavePaymentMethodInterface|array $object) : self
```

**Summary**

Устанавливает объект с информацией о способе оплаты, уведомление о котором хранится в текущем объекте.
...
| Type | Name | Description |
| ---- | ---- | ----------- |
| <code lang="php">\YooKassa\Model\SavePaymentMethod\SavePaymentMethodInterface OR array</code> | object  |  |
