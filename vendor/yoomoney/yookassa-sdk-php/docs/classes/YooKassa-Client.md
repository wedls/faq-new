...
<a name="method_getPayouts" class="anchor"></a>
...
| Type | Name | Description |
| ---- | ---- | ----------- |
| <code lang="php">array OR \YooKassa\Request\Payouts\PayoutsRequestInterface OR null</code> | filter  | Параметры фильтрации |
